...
// Migration-path coverage for the REAL current local schema version (v24 on
// master after the Batch 2 + Batch 3 merges — NOT the stale v18->v20 range
// from the original task write-up).
//
// Validates Drift's MigrationStrategy.onCreate builds the full v24 schema
...
// version 2..24 has a corresponding `if (from < N)` guard) so no upgrade step
